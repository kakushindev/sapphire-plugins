/* eslint-disable @typescript-eslint/consistent-type-imports, @typescript-eslint/explicit-function-return-type, @typescript-eslint/no-base-to-string */
...
import { BaseInteraction, ChatInputCommandInteraction, CommandInteraction, ContextMenuCommandInteraction, GuildMember, type InteractionReplyOptions, Message, MessageContextMenuCommandInteraction, type MessageCreateOptions, MessagePayload, UserContextMenuCommandInteraction } from "discord.js";
